...
def parse_args():
    ...
    parser.add_argument('--set_names', default=['Set14', 'Set12'], type=list, help='name of test dataset')
    parser.add_argument('--sigma', default=25, type=int, help='noise level')
    parser.add_argument('--model_dir', default=os.path.join('models', 'DnCNN_sigma25'), type=str,
                        help='directory of the model')
    parser.add_argument('--model_name', default='final_model.keras', type=str, help='the model name')
    ...
    for set_cur in args.set_names:
        ...
        for im in os.listdir(os.path.join(args.set_dir, set_cur)):
            if im.endswith(".jpg") or im.endswith(".bmp") or im.endswith(".png"):
                ...
                ssim_x_ = compare_ssim(x, x_, win_size=3,data_range=1.0)
                if args.save_result:
